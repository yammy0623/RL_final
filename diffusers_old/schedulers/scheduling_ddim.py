...
class DDIMSchedulerOutput(BaseOutput):
    ...
    pred_epsilon: Optional[torch.Tensor] = None
...
class DDIMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        return DDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample, pred_epsilon=pred_epsilon)
